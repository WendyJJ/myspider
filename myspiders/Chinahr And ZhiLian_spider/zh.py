...
def main():
    ...
    # 无限循环
    while True:
        source, data = rediscli.blpop(["zh:items"]) # 从redis里提取数据
        ...
        try:
            ...
            sql = 'insert into zh_job(url,pname,location,company,ptype,tags,smoney,emoney,eyear,syear,degree,person_num,time_pub,desc_job,welfare,crawl_time,webname) ' \
